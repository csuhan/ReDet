...
def HRSC2COCOTest(srcpath, destfile, cls_names):
    imageparent = os.path.join(srcpath, 'images')
    # labelparent = os.path.join(srcpath, 'labelTxt')
    data_dict = {}
    info = {'contributor': 'Jian Ding',
...
if __name__ == '__main__':
    HRSC2COCOTrain(r'data/HRSC2016/Train',
                   r'data/HRSC2016/Train/HRSC_L1_train.json',
                   L1_names)
    HRSC2COCOTest(r'data/HRSC2016/Test',
                  r'data/HRSC2016/Test/HRSC_L1_test.json',
                  L1_names)
